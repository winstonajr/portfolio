          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              },
              {
                ...
                icon: <AppWindow size={24} className="text-sky-500" />,
        ...
        <SectionWrapper id="experience">
          ...
          <div className="relative" ref={timelineRef}>
            ...
            <div className="relative pl-8 md:pl-12">
              {(showAllExperience ? experiences : experiences.slice(0, 2)).map(
                (exp, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    ...
                    <div className="absolute -left-[30px] md:-left-[46px] top-1.5 h-6 w-6 rounded-full bg-slate-50 dark:bg-slate-950 border-2 border-sky-500 flex items-center justify-center">
                      {exp.type === "work" ? (
                        ...
                        <HeartHandshake size={14} className="text-sky-500" />
                      )}
                    </div>
        ...
        <SectionWrapper id="contact">
          ...
          <div className="max-w-2xl mx-auto text-center">
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8">
              ...
              um bom bate-papo sobre tecnologia. Sinta-se à vontade para entrar
              em contato!
            </p>
